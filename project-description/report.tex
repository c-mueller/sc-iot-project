...
%\end{abstract}
    ...
    In addition we want to improve comfort of users by also regulating temperature or himidity of the a given room based on environmental factors.
    Another part of our system can be to identify human presence or out of office time and adjust the functionality of the system accordingly.
