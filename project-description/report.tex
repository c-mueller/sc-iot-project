...
%\end{abstract}
    ...
    Having good air in buildings important for a variety of different reasons.
    Depending on the type of building the effects can be different.
    In general good air regarding the right temperature, humidity and air purity makes people feel
    more comfortable and it can be considered healthier, compared to air with bad quality as a result of this effect pepole may be more productive if the air within their office has overall
    good quality.
    Another application may be retail stores there customers may stay longer if they feel more comfortable this as a result
    may result in higher revenues for the retail store.
