...
\begin{description}
    \item[ID] FA-3
    \item[Title] Recognize people in room
    \item[Description] The system should recognize how many people are currently in the rooms of the appartement.
...
\begin{description}
    \item[ID] FA-4
    \item[Title] Recognize loud environments
    \item[Description] The system should recognize when it is noisy. For example when the shower in the bathroom is turned on, it should recognize that.
    \item[Dependencies] FA-3
    \item[Priority] ++
\end{description}

\begin{description}
    \item[ID] FA-5
    \item[Title] Classify mood of the music
    \item[Description] The system should be able to identify the mood of a music that is currently played.
    \item[Dependencies] None
    \item[Priority] o
\end{description}
...
\begin{description}
    \item[ID] FA-6
    \item[Title] Light regulation
    \item[Description] The system should be able to regulate the lights in the appartement.
    \item[Dependencies] FA-5
    \item[Priority] o
\end{description}
...
\begin{description}
    \item[ID] FA-7
    \item[Title] Human music interaction
    \item[Description] A human should be able to regulate the volume of the system.
    \item[Dependencies] None
    \item[Priority] o
\end{description}
...
\begin{description}
    ...
    \item[Description] At night the humans should be prohibited from increasing the volume above a certain limit.
    \item[Dependencies] None
    \item[Priority] o
\end{description}
...
\begin{description}
    \item[ID] FA-9
    \item[Title] Classify mood of a user
    \item[Description] The system should be able to identify the mood of a user and act accordingly.
    \item[Dependencies] FA-5
    \item[Priority] o
\end{description}
...
\begin{description}
    \item[ID] FA-10
    \item[Title] Activate and deactivate speakers
    \item[Description] The system should be able to turn speakers from which music can be played on or off.
    \item[Dependencies] None
    \item[Priority] ++
\end{description}
...
\begin{description}
    ...
    \item[Description] The system should be easily transformed to a real world running smart home system.
    \item[Dependencies] None
    \item[Priority] -
\end{description}
...
\begin{description}
    \item[ID] NFA-2
    \item[Title] AI-planning
    \item[Description] AI-planning will be used for volume regulation in all the rooms.
    \item[Dependencies] None
    \item[Priority] ++
\end{description}
